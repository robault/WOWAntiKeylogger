        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (value != null && destinationType == typeof(string))
            {
                return string.Join(", ",
                    ...
                    // get resource string
                    .Select(s => _resourceManager.GetString(string.Concat(EnumType.Name, '_', s), culture) ?? s).ToArray());
            }
            else
            {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
        {
            ...
            if (stringValue != null)
            {
                ...
                ulong enumValue = Enum.GetNames(EnumType)
                    ...
                    .Select((s, i) => new KeyValuePair<int, string>(i, _resourceManager.GetString(string.Concat(EnumType.Name, '_', s), culture) ?? s))
